...
function validateFirstName() {
  if (firstName.validity.valid) {
    ...
    firstNameError.textContent = `Имя должно быть макс. ${firstName.getAttribute(
      "maxlength"
    )} букв; Вы ввели ${firstName.value.length}.`;
...
function validateLastName() {
  if (lastName.validity.valid) {
    ...
    lastNameError.textContent = `Фамилия должна быть макс. ${lastName.getAttribute(
      "maxlength"
    )} букв; Вы ввели ${lastName.value.length}.`;
...
function validateTel() {
  ...
  } else if (tel.validity.tooLong) {
    telError.textContent = `Телефон должен быть макс. ${tel.getAttribute(
      "maxlength"
    )} цифр; Вы ввели ${tel.value.length}.`;
